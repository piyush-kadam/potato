...
class _PhoneInputPageState extends State<PhoneInputPage>
  ...
  void initState() {
    ...
    // Initialize smooth fade animation - longer duration for more visible effect
    _contentAnimationController = AnimationController(
      duration: const Duration(milliseconds: 1400),
      vsync: this,
    );

    // More visible staggered fade animations with slide effect
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: AnimatedBuilder(
                              ...
                              builder: (context, child) {
                                final targetWidth = _isPhoneNumberValid
                                    ? 0.25
                                    : 0.15;
                                final animatedWidth =
                                    targetWidth * _loadingBarAnimation.value;
